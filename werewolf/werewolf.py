...
def main() -> None:
    ...
    survivors = agentscope.init(
        model_configs="./werewolf/configs/model_configs.json",
        agent_configs="./werewolf/configs/agent_configs.json",
        project="Werewolf",
    )

    roles = ["villager", "villager", "seer", "witch", "werewolf", "werewolf"]
    wolves, witch, seer = survivors[4:], survivors[-3], survivors[-4]
